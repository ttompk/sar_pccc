...
## NOTE TO USERS:
- Transport Canada has specified that required safety devices be specific to vessel type and length overall. The app therefore only shows the required safety devices specific to that vessel's configuration. 
- The app was built in April 2025 using the Transport Canada publication TP_511e which was published in 2019. Notably, a later update has acknowledged the use of electronic flares and their presence does reduce a certain number of required flares. This adjustment is not reflected in this version.
- Canadian Boat Licensing expiry was changed from 10 years to 5 years. 20226-01-22tt.
